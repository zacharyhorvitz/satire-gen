...
def do_format_to_bert(args):
    ...
    #print("Using Zach's mod")
    #data_builder.format_to_bert_zach(args)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-raw_path", default='../../satiregen/data/split_docs/') #../../line_data')
    parser.add_argument("-save_path", default='../../satiregen/data/processed_docs/')
    ...
    parser.add_argument('-log_file', default='cnndm.log')
